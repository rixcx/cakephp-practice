...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'userid' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2022-02-12 03:40:04',
                'updated_at' => '2022-02-12 03:40:04',
            ],
        ];
        parent::init();
    }
